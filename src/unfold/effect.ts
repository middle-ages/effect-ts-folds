...
export type EffectUnfold<
  ...
  E2 = unknown,
  R2 = never,
> = (a: A) => EF.Effect<Fix<F, E2, R2>, E1, R1>
...
> = (
  ...
  Kind<Outer, R2, unknown, E2, Kind<Inner, R2, unknown, E2, A>>,
  E1,
  R1
>
...
export type EffectCoalgebra<
  ...
  E2 = unknown,
  R2 = never,
> = EffectUnfolder<F, Id, A, E1, R1, E2, R2>

/**
 * Same as {@link RCoalgebra} but unfolds into an effect. A function
 * of the type:
 * `(a: A) ⇒ Effect<F<Either<A, Fix<F, E, R>>, E, R>, E, R>`
 * @category unfold
 */
